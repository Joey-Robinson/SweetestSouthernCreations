    ...
    return (
      <Menu className="sidebar" isOpen={false}>
        <ul className="bm-menu">
          ...
          <li className="bm-menu-item"><NavLink className="bm-menu-link" to="/work" activeClassName="bm-menu-item-active">My Work</NavLink></li>
          ...
          <li className="bm-menu-item"><NavLink className="bm-menu-link" to="/events" activeClassName="bm-menu-item-active">Events</NavLink></li>
        </ul>
      </Menu>
    );
  }
