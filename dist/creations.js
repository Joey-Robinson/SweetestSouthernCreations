...
imageArray.map(function (image, index) {
  var creation = document.getElementById("creations"); // Good
  var creationList = document.createElement("li"); // Good
  var creationLink = document.createElement("a"); // Good
  var creationImages = document.createElement("img"); // Good
